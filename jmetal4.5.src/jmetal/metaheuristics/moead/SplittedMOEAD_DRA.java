 ...
 * School of CS & EE, University of Essex, 02/2009 
  */
public class SplittedMOEAD_DRA extends Algorithm {
   ...
   */
  public SplittedMOEAD_DRA(Problem problem) {
    super (problem) ;
...
//      System.out.println(dataDirectory_ + "/" + dataFileName);
   ...
   */
   ...
   public void initialize () throws JMException, ClassNotFoundException {
   ...
   public SolutionSet executeIteration() throws JMException {
   ...
   public SolutionSet postExecution() throws JMException {
